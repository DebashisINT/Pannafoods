package com.breezepannafoods.features.dashboard.presentation
...
import com.breezepannafoods.*
import com.breezepannafoods.R
import com.breezepannafoods.app.*
import com.breezepannafoods.app.NewFileUtils.browseDocuments
import com.breezepannafoods.app.NewFileUtils.browsePDFDocuments
import com.breezepannafoods.app.NewFileUtils.getExtension
import com.breezepannafoods.app.domain.*
import com.breezepannafoods.app.types.DashboardType
import com.breezepannafoods.app.types.FragType
import com.breezepannafoods.app.types.TopBarConfig
import com.breezepannafoods.app.uiaction.DisplayAlert
import com.breezepannafoods.app.utils.*
import com.breezepannafoods.app.utils.AppUtils.Companion.isProfile
...
import com.breezepannafoods.features.NewQuotation.*
import com.breezepannafoods.features.NewQuotation.api.GetQuotRegProvider
import com.breezepannafoods.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezepannafoods.features.SearchLocation.SearchLocationFragment
import com.breezepannafoods.features.SearchLocation.locationInfoModel
import com.breezepannafoods.features.TA.ViewAllTAListFragment
import com.breezepannafoods.features.achievement.AchievementFragment
import com.breezepannafoods.features.activities.presentation.*
import com.breezepannafoods.features.addAttendence.*
import com.breezepannafoods.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezepannafoods.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezepannafoods.features.addAttendence.model.GetReportToFCMResponse
import com.breezepannafoods.features.addAttendence.model.GetReportToResponse
import com.breezepannafoods.features.addAttendence.model.Leave_list_Response
import com.breezepannafoods.features.addorder.presentation.AddOrderFragment
...
import com.breezepannafoods.features.addshop.presentation.AddShopFragment
import com.breezepannafoods.features.addshop.presentation.OTPVerificationDialog
import com.breezepannafoods.features.addshop.presentation.ScanImageFragment
import com.breezepannafoods.features.addshop.presentation.ShowCardDetailsDialog
import com.breezepannafoods.features.alarm.model.AlarmData
import com.breezepannafoods.features.alarm.presetation.AttendanceReportFragment
import com.breezepannafoods.features.alarm.presetation.PerformanceReportFragment
import com.breezepannafoods.features.alarm.presetation.VisitReportDetailsFragment
import com.breezepannafoods.features.alarm.presetation.VisitReportFragment
import com.breezepannafoods.features.attendance.AttendanceFragment
import com.breezepannafoods.features.attendance.api.AttendanceRepositoryProvider
import com.breezepannafoods.features.attendance.model.AttendanceRequest
import com.breezepannafoods.features.attendance.model.AttendanceResponse
import com.breezepannafoods.features.averageshop.presentation.AverageShopFragment
import com.breezepannafoods.features.avgorder.presentation.AverageOrderFragment
import com.breezepannafoods.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezepannafoods.features.beatCustom.TeamBeatListFragment
import com.breezepannafoods.features.billing.presentation.AddBillingFragment
import com.breezepannafoods.features.billing.presentation.BillingDetailsFragment
import com.breezepannafoods.features.billing.presentation.BillingListFragment
import com.breezepannafoods.features.changepassword.presentation.ChangePasswordDialog
import com.breezepannafoods.features.chat.model.ChatListDataModel
import com.breezepannafoods.features.chat.model.ChatUserDataModel
import com.breezepannafoods.features.chat.model.GroupUserDataModel
import com.breezepannafoods.features.chat.presentation.*
import com.breezepannafoods.features.chatbot.presentation.ChatBotFragment
import com.breezepannafoods.features.chatbot.presentation.ChatBotShopListFragment
import com.breezepannafoods.features.chatbot.presentation.ReportsFragment
import com.breezepannafoods.features.chatbot.presentation.SelectLanguageDialog
import com.breezepannafoods.features.commondialog.presentation.CommonDialog
import com.breezepannafoods.features.commondialog.presentation.CommonDialogClickListener
import com.breezepannafoods.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezepannafoods.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezepannafoods.features.commondialogsinglebtn.OnDialogClickListener
import com.breezepannafoods.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezepannafoods.features.contacts.ActivityDtlsFrag
import com.breezepannafoods.features.contacts.AddOpptFrag
import com.breezepannafoods.features.contacts.ContactDtls
import com.breezepannafoods.features.contacts.ContactGr
import com.breezepannafoods.features.contacts.ContactsAddFrag
import com.breezepannafoods.features.contacts.ContactsFrag
import com.breezepannafoods.features.contacts.SchedulerAddFormFrag
import com.breezepannafoods.features.contacts.SchedulerViewFrag
import com.breezepannafoods.features.contacts.TemplateAddFrag
import com.breezepannafoods.features.contacts.TemplateViewFrag
import com.breezepannafoods.features.contacts.ViewCrmOpptFrag
import com.breezepannafoods.features.dailyPlan.prsentation.AllShopListFragment
import com.breezepannafoods.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezepannafoods.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezepannafoods.features.damageProduct.ShopDamageProductListFrag
import com.breezepannafoods.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezepannafoods.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezepannafoods.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezepannafoods.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezepannafoods.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezepannafoods.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezepannafoods.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezepannafoods.features.dashboard.presentation.model.ContentListResponseModel
import com.breezepannafoods.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezepannafoods.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezepannafoods.features.device_info.presentation.DeviceInfoListFragment
import com.breezepannafoods.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezepannafoods.features.document.DocumentRepoFeatureNewFragment
import com.breezepannafoods.features.document.presentation.DocumentListFragment
import com.breezepannafoods.features.document.presentation.DocumentTypeListFragment
import com.breezepannafoods.features.document.presentation.OpenFileWebViewFragment
import com.breezepannafoods.features.dymanicSection.presentation.AddDynamicFragment
import com.breezepannafoods.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezepannafoods.features.dymanicSection.presentation.DynamicListFragment
import com.breezepannafoods.features.dymanicSection.presentation.EditDynamicFragment
import com.breezepannafoods.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezepannafoods.features.home.presentation.HomeFragment
import com.breezepannafoods.features.homelocation.presentation.HomeLocationFragment
import com.breezepannafoods.features.homelocation.presentation.HomeLocationMapFragment
import com.breezepannafoods.features.know_your_state.KnowYourStateFragment
import com.breezepannafoods.features.lead.LeadFrag
import com.breezepannafoods.features.lead.ViewLeadFrag
import com.breezepannafoods.features.leaderboard.LeaderBoardFrag
import com.breezepannafoods.features.leaveapplynew.LeaveHome
import com.breezepannafoods.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezepannafoods.features.localshops.LocalShopListFragment
import com.breezepannafoods.features.localshops.LocalShopListMapFragment
import com.breezepannafoods.features.localshops.NearByShopsMapFragment
import com.breezepannafoods.features.location.*
import com.breezepannafoods.features.location.api.LocationRepoProvider
import com.breezepannafoods.features.location.model.*
import com.breezepannafoods.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezepannafoods.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezepannafoods.features.login.ShopFeedbackEntity
import com.breezepannafoods.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezepannafoods.features.login.presentation.LoginActivity
import com.breezepannafoods.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezepannafoods.features.logoutsync.presentation.LogoutSyncFragment
import com.breezepannafoods.features.marketAssist.MarketAssistTabFrag
import com.breezepannafoods.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezepannafoods.features.marketAssist.ShopListMarketAssistFrag
import com.breezepannafoods.features.marketing.presentation.MarketingPagerFragment
import com.breezepannafoods.features.meetinglist.prsentation.MeetingListFragment
import com.breezepannafoods.features.member.MapViewForTeamFrag
import com.breezepannafoods.features.member.model.TeamLocDataModel
import com.breezepannafoods.features.member.model.TeamShopListDataModel
import com.breezepannafoods.features.member.presentation.*
import com.breezepannafoods.features.menuBeat.MenuBeatFrag
import com.breezepannafoods.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezepannafoods.features.micro_learning.presentation.MicroLearningListFragment
import com.breezepannafoods.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezepannafoods.features.myallowancerequest.MyallowanceRequestFragment
import com.breezepannafoods.features.myjobs.model.CustomerDataModel
import com.breezepannafoods.features.myjobs.presentation.*
import com.breezepannafoods.features.myorder.presentation.MyOrderListFragment
import com.breezepannafoods.features.myprofile.presentation.MyProfileFragment
import com.breezepannafoods.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezepannafoods.features.nearbyshops.model.ShopData
import com.breezepannafoods.features.nearbyshops.model.ShopListResponse
import com.breezepannafoods.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezepannafoods.features.nearbyshops.presentation.BeatListFragment
import com.breezepannafoods.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezepannafoods.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezepannafoods.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezepannafoods.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezepannafoods.features.newcollection.CollectionDetailsStatusFragment
import com.breezepannafoods.features.newcollection.CollectionShopListFragment
import com.breezepannafoods.features.newcollection.NewCollectionListFragment
import com.breezepannafoods.features.newcollectionreport.*
import com.breezepannafoods.features.notification.NotificationFragment
import com.breezepannafoods.features.orderITC.CartListFrag
import com.breezepannafoods.features.orderITC.OrderListFrag
import com.breezepannafoods.features.orderITC.ProductListFrag
import com.breezepannafoods.features.orderITC.ViewNewOrdHisAllFrag
import com.breezepannafoods.features.orderITC.ViewNewOrdHistoryFrag
import com.breezepannafoods.features.orderITC.ViewOrdDtls
import com.breezepannafoods.features.orderList.NewDateWiseOrderListFragment
import com.breezepannafoods.features.orderList.NewOrderListFragment
import com.breezepannafoods.features.orderList.OrderListFragment
import com.breezepannafoods.features.orderdetail.presentation.OrderDetailFragment
import com.breezepannafoods.features.orderhistory.ActivityMapFragment
import com.breezepannafoods.features.orderhistory.OrderhistoryFragment
import com.breezepannafoods.features.orderhistory.TimeLineFragment
import com.breezepannafoods.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezepannafoods.features.orderhistory.model.FetchLocationRequest
import com.breezepannafoods.features.orderhistory.model.FetchLocationResponse
import com.breezepannafoods.features.orderhistory.model.LocationData
import com.breezepannafoods.features.pendinglocationinout.PendingOutLocationFrag
import com.breezepannafoods.features.performance.GpsStatusFragment
import com.breezepannafoods.features.performance.PerformanceFragment
import com.breezepannafoods.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezepannafoods.features.performance.model.UpdateGpsInputParamsModel
import com.breezepannafoods.features.performanceAPP.OwnPerformanceFragment
import com.breezepannafoods.features.performanceAPP.PerformanceAppFragment
import com.breezepannafoods.features.performanceAPP.allPerformanceFrag
import com.breezepannafoods.features.permissionList.ViewPermissionFragment
import com.breezepannafoods.features.photoReg.*
import com.breezepannafoods.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezepannafoods.features.quotation.presentation.*
import com.breezepannafoods.features.reimbursement.presentation.*
import com.breezepannafoods.features.report.presentation.*
import com.breezepannafoods.features.returnsOrder.*
import com.breezepannafoods.features.settings.presentation.SettingsFragment
import com.breezepannafoods.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezepannafoods.features.shopdetail.presentation.*
import com.breezepannafoods.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezepannafoods.features.stock.StockDetailsFragment
import com.breezepannafoods.features.stock.StockListFragment
import com.breezepannafoods.features.stockAddCurrentStock.AddShopStockFragment
import com.breezepannafoods.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezepannafoods.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezepannafoods.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezepannafoods.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezepannafoods.features.stockCompetetorStock.CompetetorStockFragment
import com.breezepannafoods.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezepannafoods.features.survey.SurveyFrag
import com.breezepannafoods.features.survey.SurveyViewDtlsFrag
import com.breezepannafoods.features.survey.SurveyViewFrag
import com.breezepannafoods.features.task.presentation.AddTaskFragment
import com.breezepannafoods.features.task.presentation.CalenderTaskFragment
import com.breezepannafoods.features.task.presentation.EditTaskFragment
import com.breezepannafoods.features.task.presentation.TaskListFragment
import com.breezepannafoods.features.taskManagement.TaskManagementFrag
import com.breezepannafoods.features.taskManagement.ViewTaskManagementFrag
import com.breezepannafoods.features.timesheet.presentation.AddTimeSheetFragment
import com.breezepannafoods.features.timesheet.presentation.EditTimeSheetFragment
import com.breezepannafoods.features.timesheet.presentation.TimeSheetListFragment
import com.breezepannafoods.features.viewAllOrder.CartFragment
import com.breezepannafoods.features.viewAllOrder.OrderTypeListFragment
import com.breezepannafoods.features.viewAllOrder.ViewAllOrderListFragment
import com.breezepannafoods.features.viewAllOrder.ViewCartFragment
import com.breezepannafoods.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezepannafoods.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezepannafoods.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezepannafoods.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezepannafoods.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezepannafoods.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezepannafoods.features.viewPPDDStock.ViewOutstandingFragment
import com.breezepannafoods.features.viewPPDDStock.ViewPPDDListFragment
import com.breezepannafoods.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezepannafoods.features.viewPPDDStock.ViewStockFragment
import com.breezepannafoods.features.weather.presentation.WeatherFragment
import com.breezepannafoods.mappackage.MapActivity
import com.breezepannafoods.mappackage.MapActivityWithoutPath
import com.breezepannafoods.mappackage.SendBrod
import com.breezepannafoods.widgets.AppCustomEditText
...
import com.breezepannafoods.features.NewQuotation.ViewAllQuotListFragment.Companion.shop_name
import com.breezepannafoods.features.addshop.model.AudioFetchDataCLass
import com.breezepannafoods.features.contacts.LoanDtlsFrag
import com.breezepannafoods.features.login.api.opportunity.OpportunityRepoProvider
import com.breezepannafoods.features.login.model.NewSettingsResponseModel
import com.breezepannafoods.features.performanceAPP.TargetVSAchvFrag
import com.breezepannafoods.features.performanceAPP.TargetVSAchvDtlsFrag
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezepannafoodslogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezepannafoodslogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezepannafoods/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezepannafoodslogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezepannafoodslogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezepannafoodslogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
