package com.breezepannafoods.features.logoutsync.presentation
...
import com.breezepannafoods.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezepannafoods.features.billing.api.AddBillingRepoProvider
import com.breezepannafoods.features.billing.model.AddBillingInputParamsModel
...
import com.breezepannafoods.features.dashboard.presentation.ReasonDialog
...
import com.breezepannafoods.features.document.model.AddEditDocumentInputParams
import com.breezepannafoods.features.document.model.DocumentAttachmentModel
...
import com.breezepannafoods.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezepannafoods.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezepannafoods.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezepannafoods.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezepannafoods.features.orderhistory.model.*
...
import com.breezepannafoods.features.quotation.model.AddQuotInputModel
import com.breezepannafoods.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezepannafoods.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezepannafoods.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezepannafoods.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezepannafoods.features.timesheet.model.AddTimeSheetInputModel
import com.breezepannafoods.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezepannafoods.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezepannafoods.features.viewAllOrder.model.AddOrderInputProductList
import com.breezepannafoods.mappackage.SendBrod
import com.breezepannafoods.widgets.AppCustomTextView
import com.breezepannafoods.MonitorService
import com.breezepannafoods.MySingleton
import com.breezepannafoods.app.AlarmReceiver
...
import com.breezepannafoods.features.addshop.presentation.ShopExtraContactReq
...
import com.breezepannafoods.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezepannafoods.features.login.model.GetConcurrentUserResponse
...
import com.breezepannafoods.features.orderITC.SyncDeleteOpptL
import com.breezepannafoods.features.orderITC.SyncEditOppt
import com.breezepannafoods.features.orderITC.SyncOppt
import com.breezepannafoods.features.orderITC.SyncOpptProductL
import com.breezepannafoods.features.orderITC.SyncOrd
import com.breezepannafoods.features.orderITC.SyncOrdProductL
import com.breezepannafoods.features.performance.model.Gps_status_list
import com.breezepannafoods.features.performance.model.UpdateGpsInputListParamsModel
import com.breezepannafoods.features.returnsOrder.ReturnProductList
import com.breezepannafoods.features.returnsOrder.ReturnRequest
import com.breezepannafoods.features.viewAllOrder.model.NewOrderSaveApiModel
import com.breezepannafoods.features.viewAllOrder.model.NewStockSync
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezepannafoods/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezepannafoodslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezepannafoodslogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezepannafoodslogsample/log.zip").path);
