package com.breezepannafoods.features.commondialogsinglebtn
...
import com.breezepannafoods.app.domain.ShopVisitCompetetorModelEntity
import com.breezepannafoods.app.domain.VisitRemarksEntity
...
import com.breezepannafoods.features.addshop.presentation.ProspectListDialog
import com.breezepannafoods.features.dashboard.presentation.DashboardActivity
import com.breezepannafoods.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezepannafoods.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezepannafoods/files", "recorded_audio${System.currentTimeMillis()}.mp3")
