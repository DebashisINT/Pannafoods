...
import com.breezepannafoods.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezepannafoods.app.utils.FTStorageUtils
import com.breezepannafoods.app.utils.NotificationUtils
...
import com.breezepannafoods.features.addshop.model.AssignedToShopListResponseModel
import com.breezepannafoods.features.addshop.model.QuestionSubmit
...
import com.breezepannafoods.features.addshop.presentation.*
...
import com.breezepannafoods.features.location.model.ShopDurationRequestData
...
import com.breezepannafoods.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezepannafoods.features.marketing.model.MarketingCategoryListResponse
...
import com.breezepannafoods.features.nearbyshops.model.StageListResponseModel
...
import com.breezepannafoods.features.shopdetail.presentation.AddCollectionDialog
...
import com.breezepannafoods.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezepannafoodsApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
